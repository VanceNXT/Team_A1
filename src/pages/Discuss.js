...
import Vance from "../assets/vancelogo.png";
...
function About() {
  return (
    <div className="about">
      <div
        className="aboutTop"
        style={{ backgroundImage: `url(${Vance})` }}
        
      ><h1 className="centered"> Discussion Forum</h1></div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-9 mb-3">
            <div className="row text-left mb-5">
              <div className="col-lg-6 mb-3 mb-sm-0">
                <div className="dropdown bootstrap-select form-control form-control-lg bg-white bg-op-9 text-sm w-lg-50" style={{width: '100%'}}>
                  <select className="form-control form-control-lg bg-white bg-op-9 text-sm w-lg-50" data-toggle="select" tabIndex={-98}>
              ...
              <div className="col-lg-6 text-lg-right">
                <div className="dropdown bootstrap-select form-control form-control-lg bg-white bg-op-9 ml-auto text-sm w-lg-50" style={{width: '100%'}}>
                  <select className="form-control form-control-lg bg-white bg-op-9 ml-auto text-sm w-lg-50" data-toggle="select" tabIndex={-98}>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">245 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">116 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">257 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-warning border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">49 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">29 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">170 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">164 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">82 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">240 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-danger border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">180 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">35 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">44 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">236 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">79 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">162 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">130 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">121 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">191 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">194 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">16 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">113 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">179 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">194 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">167 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">11 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">120 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">240 Views</span> </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-danger border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">25 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">211 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">234 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">70 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">187 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">234 Views</span> </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">288 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">206 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">1 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">144 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">92 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">25 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card row-hover pos-relative py-3 px-3 mb-3 border-primary border-top-0 border-right-0 border-bottom-0 rounded-0">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 op-7">
                  <div className="row text-center op-7">
                    <div className="col px-1"> <i className="ion-connection-bars icon-1x" /> <span className="d-block text-sm">199 Votes</span> </div>
                    <div className="col px-1"> <i className="ion-ios-chatboxes-outline icon-1x" /> <span className="d-block text-sm">75 Replys</span> </div>
                    <div className="col px-1"> <i className="ion-ios-eye-outline icon-1x" /> <span className="d-block text-sm">61 Views</span> </div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-3 mb-4 mb-lg-0 px-lg-0 mt-lg-0">
            <div style={{visibility: 'hidden', display: 'none', width: '285px', height: '801px', margin: '0px', float: 'none', position: 'static', inset: '85px auto auto'}} /><div data-settings="{&quot;parent&quot;:&quot;#content&quot;,&quot;mind&quot;:&quot;#header&quot;,&quot;top&quot;:10,&quot;breakpoint&quot;:992}" data-toggle="sticky" className="sticky" style={{top: '85px'}}><div className="sticky-inner">
